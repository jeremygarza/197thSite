...
class SupportContactsControllerTest < ActionController::TestCase
  ...
  test "should create support_contact" do
    assert_difference('SupportContact.count') do
      post :create, support_contact: { first_name: @support_contact.first_name, last_name: @support_contact.last_name, phone: @support_contact.phone, position: @support_contact.position, rank: @support_contact.rank }
    end
  ...
  test "should update support_contact" do
    patch :update, id: @support_contact, support_contact: { first_name: @support_contact.first_name, last_name: @support_contact.last_name, phone: @support_contact.phone, position: @support_contact.position, rank: @support_contact.rank }
    assert_redirected_to support_contact_path(assigns(:support_contact))
  end
